...
! function(e, t) {
    ...
    var Framework7 = function(i) {
        ...
        Support = (qp = !1, rp = doc.createElement("div"), "sticky -webkit-sticky -moz-sticky".split(" ").forEach(function(e) {
            qp || (rp.style.position = e, rp.style.position === e && (qp = !0))
        }), np = qp, op = doc.createElement("div"), {
            positionSticky: np,
            touch: !!("ontouchstart" in win || win.DocumentTouch && doc instanceof win.DocumentTouch),
            pointerEvents: !(!win.navigator.pointerEnabled && !win.PointerEvent),
            prefixedPointerEvents: !!win.navigator.msPointerEnabled,
            transition: (vp = op.style, "transition" in vp || "webkitTransition" in vp || "MozTransition" in vp),
            transforms3d: win.Modernizr && !0 === win.Modernizr.csstransforms3d || (xp = op.style, "webkitPerspective" in xp || "MozPerspective" in xp || "OPerspective" in xp || "MsPerspective" in xp || "perspective" in xp),
            flexbox: function() {
        ...
        qp, rp, xp, vp, np, op, SupportModule = {
            name: "support",
            proto: {
                support: Support
            },
    ...
    function initTouch() {
        ...
        doc.addEventListener("click", function(e) {
            D("click", e)
        }, !0), Support.passiveListener ? (doc.addEventListener(o.touchEvents.start, I, U), doc.addEventListener(o.touchEvents.move, A, U), doc.addEventListener(o.touchEvents.end, B, U), doc.addEventListener(o.touchEvents.start, L, H), doc.addEventListener(o.touchEvents.move, R, H), doc.addEventListener(o.touchEvents.end, z, H)) : (doc.addEventListener(o.touchEvents.start, function(e) {
            I(e), L(e)
            ...
            x.disableContextMenu && (Device.ios || Device.android || Device.cordova) && e.preventDefault(), E && (b && M(), O())
        })
    }
    var TouchModule = {
            name: "touch",
    ...
    function SwipeBack(e) {
        ...
        function r(e) {
            ...
            !n || !t || O || M.swipeout && M.swipeout.el || !k.allowPageChange || 0 < $(e.target).closest(".range-slider, .calendar-months").length || (O = !(D = !1), d = void 0, I.x = "touchstart" === e.type ? e.targetTouches[0].pageX : e.pageX, I.y = "touchstart" === e.type ? e.targetTouches[0].pageY : e.pageY, a = Utils.now(), y = k.dynamicNavbar, w = k.separateNavbar)
        }
            ...
            if (O) {
                ...
                if (void 0 === d && (d = !!(d || Math.abs(a - I.y) > Math.abs(t - I.x)) || t < I.x && !M.rtl || t > I.x && M.rtl), d || e.f7PreventSwipeBack || M.preventSwipeBack) O = !1;
                    ...
                    if (!D) {
                        ...
                        z && 0 === (C = A.find(".page-shadow-effect")).length && (C = $('<div class="page-shadow-effect"></div>'), A.append(C)), H && 0 === (x = B.find(".page-opacity-effect")).length && (x = $('<div class="page-opacity-effect"></div>'), B.append(x)), y && (w ? (L = T.find(".navbar-current:not(.stacked)"), R = T.find(".navbar-previous:not(.stacked)")) : (L = A.children(".navbar").children(".navbar-inner"), R = B.children(".navbar").children(".navbar-inner")), E = T[0].offsetWidth, f = L.children(".left, .title, .right, .subnavbar, .fading"), m = R.children(".left, .title, .right, .subnavbar, .fading"), P.iosAnimateNavbarBackIcon && (L.hasClass("sliding") ? (v = L.children(".left").find(".back .icon"), g = L.children(".left").find(".back span").eq(0)) : (v = L.children(".left.sliding").find(".back .icon"), g = L.children(".left.sliding").find(".back span").eq(0)), b = R.hasClass("sliding") ? R.children(".left").find(".back .icon") : R.children(".left.sliding").find(".back .icon"))), 0 < $(".sheet.modal-in").length && M.sheet && M.sheet.close($(".sheet.modal-in"))
                    }
        ...
        function o() {
            if (M.preventSwipePanelBySwipeBack = !1, O && D) {
                if (D = O = !1, k.swipeBackActive = !1, $([A[0], B[0]]).removeClass("page-swipeback-active"), 0 === h) return $([A[0], B[0]]).transform(""), C && 0 < C.length && C.remove(), x && 0 < x.length && x.remove(), void(y && (f.transform("").css({
                    opacity: ""
                }), m.transform("").css({
                    opacity: ""
                ...
                i ? (k.currentRoute = B[0].f7Page.route, k.currentPage = B[0], k.pageCallback("beforeOut", A, L, "current", "next", {
                    ...
                    swipeBack: !0
                }), S.trigger("swipeback:beforechange", t), k.emit("swipebackBeforeChange", t)) : (S.trigger("swipeback:beforereset", t), k.emit("swipebackBeforeReset", t)), A.transitionEnd(function() {
                    $([A[0], B[0]]).removeClass("page-transitioning page-transitioning-swipeback"), y && (f.removeClass("navbar-transitioning").css({
                        opacity: ""
                    }).transform(""), m.removeClass("navbar-transitioning").css({
                        opacity: ""
                    }).transform(""), v && 0 < v.length && v.removeClass("navbar-transitioning"), b && 0 < b.length && b.removeClass("navbar-transitioning")), n = !0, k.allowPageChange = !0, i ? (1 === k.history.length && k.history.unshift(k.url), k.history.pop(), k.saveHistory(), P.pushState && History.back(), k.pageCallback("afterOut", A, L, "current", "next", {
                        route: A[0].f7Page.route,
                        swipeBack: !0
                    }), k.pageCallback("afterIn", B, R, "previous", "current", {
                        route: B[0].f7Page.route,
                        swipeBack: !0
                    }), P.stackPages && 0 <= k.initialPages.indexOf(A[0]) ? (A.addClass("stacked"), w && L.addClass("stacked")) : (k.pageCallback("beforeRemove", A, L, "next", {
                        swipeBack: !0
                    }), k.removePage(A), w && k.removeNavbar(L)), S.trigger("swipeback:afterchange", t), k.emit("swipebackAfterChange", t), k.emit("routeChanged", k.currentRoute, k.previousRoute, k), P.preloadPreviousPage && k.back(k.history[k.history.length - 2], {
                        preload: !0
                    })) : (S.trigger("swipeback:afterreset", t), k.emit("swipebackAfterReset", t)), C && 0 < C.length && C.remove(), x && 0 < x.length && x.remove()
                })
            } else D = O = !1
        }
        t = !("touchstart" !== M.touchEvents.start || !Support.passiveListener) && {
            passive: !0,
            capture: !1
        }, S.on(M.touchEvents.start, r, t), M.on("touchmove:active", i), M.on("touchend:passive", o), k.on("routerDestroy", function() {
    ...
    function forward(e, t) {
        ...
        if (v && (w = u.children(".navbar-inner:not(.stacked)").filter(function(e, t) {
                return t !== h[0]
            })), o.reloadPrevious && C.length < 2) return r.allowPageChange = !0, r;
        var x = "next";
        if (o.reloadCurrent || o.reloadAll ? x = "current" : o.reloadPrevious && (x = "previous"), b.addClass("page-" + x).removeClass("stacked"), m && h.length && h.addClass("navbar-" + x).removeClass("stacked"), o.reloadCurrent) d = C.eq(C.length - 1), v && (f = $(i.navbar.getElByPage(d)));
        else if (o.reloadPrevious) d = C.eq(C.length - 2), v && (f = $(i.navbar.getElByPage(d)));
        else if (o.reloadAll) d = C.filter(function(e, t) {
            return t !== b[0]
            ...
            if (1 < C.length) {
                ...
                for (E = 0; E < C.length - 1; E += 1) {
                    ...
                    r.params.stackPages ? (C.eq(E).addClass("stacked"), v && $(k).addClass("stacked")) : (r.pageCallback("beforeRemove", C[E], w && w[E], "previous", void 0, o), r.removePage(C[E]), v && k && r.removeNavbar(k))
                }
            }
        ...
        if (o.reloadPrevious ? (P && !M ? P.$mount(function(e) {
                $(e).insertBefore(d)
            }) : b.insertBefore(d), v && h.length && (f.length ? h.insertBefore(f) : (r.$navbarEl.parents(doc).length || r.$el.prepend(r.$navbarEl), u.append(h)))) : (d.next(".page")[0] !== b[0] && (P && !M ? P.$mount(function(e) {
                g.append(e)
            }) : g.append(b[0])), v && h.length && (r.$navbarEl.parents(doc).length || r.$el.prepend(r.$navbarEl), u.append(h[0]))), M || r.pageCallback("mounted", b, h, x, y ? x : "current", o, d), o.reloadCurrent && 0 < d.length ? r.params.stackPages && 0 <= r.initialPages.indexOf(d[0]) ? (d.addClass("stacked"), v && f.addClass("stacked")) : (r.pageCallback("beforeRemove", d, f, "previous", void 0, o), r.removePage(d), v && f && f.length && r.removeNavbar(f)) : o.reloadAll ? d.each(function(e, t) {
                var a = $(t),
                ...
                history: !1,
                pushState: !1
            })), r.pageCallback("init", b, h, x, y ? x : "current", o, d), o.reloadCurrent || o.reloadAll) return r.allowPageChange = !0, r.pageCallback("beforeIn", b, h, x, "current", o), r.pageCallback("afterIn", b, h, x, "current", o), o.reloadCurrent && o.clearPreviousHistory && r.clearPreviousHistory(), r;
        ...
        if (r.pageCallback("beforeIn", b, h, "next", "current", o), r.pageCallback("beforeOut", d, f, "current", "previous", o), o.animate) {
            ...
            I ? setTimeout(function() {
                D(), r.animate(d, b, f, h, "forward", function() {
                    O()
                })
            }, I) : (D(), r.animate(d, b, f, h, "forward", function() {
                O()
            }))
        } else O();
        return r
        ...
        function l(e, t) {
            ...
            function p(e) {
                u.allowPageChange = !0, e && ("string" == typeof e ? h.html(e) : (h.html(""), e.f7Component ? e.f7Component.$mount(function(e) {
                    ...
                    var t = h;
                    "string" != typeof e && (t = $(e)), t.trigger("tab:init tab:mounted", d), u.emit("tabInit tabMounted", h[0], d), f && f.length && (m ? v(function() {
    ...
    function modalLoad(n, r, e) {
        ...
        function h() {
            ...
            t.on(o + "Open", function() {
                ...
                url: s.route.url,
                modal: n
            }, (c.params.pushStateRoot || "") + c.params.pushStateSeparator + s.route.url), s.route !== c.currentRoute && (t.route = Utils.extend(s.route, {
                modal: t
            }), c.currentRoute = t.route), s.history && (c.history.push(s.route.url), c.saveHistory())), e && (c.removeThemeElements(t.el), t.$el.trigger(n.toLowerCase() + ":init " + n.toLowerCase() + ":mounted", r, t), c.emit(o + "Init " + n + "Init " + n + "Mounted", t.el, r, t)), t.open()
        }
    ...
    function backward(e, t) {
        ...
        if (o.removeThemeElements(u), u.addClass("page-previous").removeClass("stacked").removeAttr("aria-hidden"), c && 0 < n.length && n.addClass("navbar-previous").removeClass("stacked").removeAttr("aria-hidden"), p.force && (0 < h.prev(".page-previous:not(.stacked)").length || 0 === h.prev(".page-previous").length))
            if (0 <= o.history.indexOf(p.route.url) ? (i = o.history.length - o.history.indexOf(p.route.url) - 1, o.history = o.history.slice(0, o.history.indexOf(p.route.url) + 2), l.history = o.history) : o.history[[o.history.length - 2]] ? o.history[o.history.length - 2] = p.route.url : o.history.unshift(o.url), i && o.params.stackPages) h.prevAll(".page-previous").each(function(e, t) {
                var a, n = $(t);
                d && (a = $(s.navbar.getElByPage(n))), n[0] !== u[0] && n.index() > u.index() && (0 <= o.initialPages.indexOf(n[0]) ? (n.addClass("stacked"), d && a.addClass("stacked")) : (o.pageCallback("beforeRemove", n, a, "previous", void 0, p), o.removePage(n), d && 0 < a.length && o.removeNavbar(a)))
            });
            else {
                var f, m = h.prev(".page-previous:not(.stacked)");
                d && (f = $(s.navbar.getElByPage(m))), o.params.stackPages && 0 <= o.initialPages.indexOf(m[0]) ? (m.addClass("stacked"), f.addClass("stacked")) : 0 < m.length && (o.pageCallback("beforeRemove", m, f, "previous", void 0, p), o.removePage(m), d && f.length && o.removeNavbar(f))
            }
        ...
        if (p.preload) return w(), p.route.route.tab && o.tabLoad(p.route.route.tab, Utils.extend({}, p, {
            ...
            var a, n = $(t);
            d && (a = $(s.navbar.getElByPage(n))), o.params.stackPages && 0 <= o.initialPages.indexOf(t) ? (n.addClass("stacked"), d && a.addClass("stacked")) : (o.pageCallback("beforeRemove", n, a, "previous", void 0), o.removePage(n), d && a.length && o.removeNavbar(a))
    ...
    function back() {
        ...
        if (u || "popup popover sheet loginScreen actions customModal panel".split(" ").forEach(function(e) {
            ...
            }), h && f ? (o.params.pushState && !1 !== r.pushState && History.back(), o.currentRoute = h, o.history.pop(), o.saveHistory(), o.modalRemove(f), o) : o
        }
        ...
        if (i.route.options ? Utils.extend(w, i.route.options, r, {
                ...
                route: i
            }), w && w.context && (i.context = w.context, w.route.context = w.context), w.force && o.params.stackPages && (o.$el.children(".page-previous.stacked").each(function(e, t) {
        ...
        function C() {
            ...
            "url content component pageName el componentUrl template templateUrl".split(" ").forEach(function(e) {
                ...
                o.allowPageChange = !1, t && t.context && (i.context ? i.context = Utils.extend({}, i.context, t.context) : i.context = t.context, w.route.context = i.context), o.loadBack(e, Utils.extend(w, t), !0)
            }, function() {
                o.allowPageChange = !0
            }))
        }
        ...
        return i && (e.__proto__ = i), ((e.prototype = Object.create(i && i.prototype)).constructor = e).prototype.animatableNavElements = function(a, n) {
            ...
            if (void 0 === i && (i = {}), t) {
                ...
                if (l.length) {
                    ...
                    }), l[0].f7RouteEventsAttached = null, l[0].f7RouteEventsOn = null, l[0].f7RouteEventsOnce = null, delete l[0].f7RouteEventsAttached, delete l[0].f7RouteEventsOn, delete l[0].f7RouteEventsOnce), l[0].f7Page && l[0].f7Page.navbarEl && delete l[0].f7Page.navbarEl.f7Page, l[0].f7Page = null)
                }
            }
    ...
    function getData(e, s, t, a, l) {
        ...
        Array.prototype.forEach.call(n, function(e) {
            ...
            if (0 <= propsAttrs.indexOf(t)) p.props || (p.props = {}), "readonly" === t && (t = "readOnly"), 0 <= booleanProps.indexOf(t) ? p.props[t] = !1 !== a : p.props[t] = a;
                ...
                if (0 <= a.indexOf("{") && 0 <= a.indexOf("}")) try {
                    p.style = JSON.parse(a)
                } catch (e) {
                    p.attrs || (p.attrs = {}), p.attrs.style = a
                } else p.attrs || (p.attrs = {}), p.attrs.style = a;
    ...
    function parseComponent(e) {
        ...
        s = "window." + n + " = function () {" + s + "}", (l = doc.createElement("script")).innerHTML = s, $("head").append(l);
        var u = win[n]();
    ...
    Framework7Component.prototype.$attachEvents = function() {
        ...
        var e = this;
        e.$options.beforeDestroy && e.$options.beforeDestroy(), e.$styleEl && $(e.$styleEl).remove(), e.$detachEvents(), e.$options.destroyed && e.$options.destroyed(), e.el && e.el.f7Component && (e.el.f7Component = null, delete e.el.f7Component), e.$vnode && (e.$vnode = patch(e.$vnode, {
            sel: e.$vnode.sel,
            data: {}
        })), Utils.deleteProps(e)
    };
    var ComponentModule = {
        ...
        Statusbar = {
            ...
            iosOverlaysWebView: function(e) {
                void 0 === e && (e = !0), Device.ios && Device.cordova && win.StatusBar && (win.StatusBar.overlaysWebView(e), e ? $("html").addClass("with-statusbar") : $("html").removeClass("with-statusbar"))
            },
            ...
            init: function() {
                ...
                t.enabled && ("auto" === t.overlay ? (Device.needsStatusbarOverlay() ? $("html").addClass("with-statusbar") : $("html").removeClass("with-statusbar"), Device.ios && (Device.cordova || Device.webView) && (0 === win.orientation && e.once("resize", function() {
    ...
    var View$1 = {
        ...
        Navbar = {
            size: function(e) {
                ...
                if ("ios" === a.theme) {
                    ...
                    if (t.hasClass("navbar")) t = t.children(".navbar-inner").each(function(e, t) {
                        ...
                        var k = (y - v) / 2;
                        v < y - f - m ? (k < f && (k = f), y - m < k + v && (k = y - m - v), o = k - i) : o = 0;
                        var S = a.rtl ? -1 : 1;
                        if (r) {
            ...
            getElByPage: function(e) {
                var t, a, n;
                if (e.$navbarEl || e.$el ? t = (n = e).$el : 0 < (t = $(e)).length && (n = t[0].f7Page), n && n.$navbarEl && 0 < n.$navbarEl.length ? a = n.$navbarEl : t && (a = t.children(".navbar").children(".navbar-inner")), a && (!a || 0 !== a.length)) return a[0]
            },
        ...
        TouchRipple = function(e, t, a) {
            ...
            if (e) {
                ...
                return n.$rippleWaveEl = $('<div class="ripple-wave" style="width: ' + p + "px; height: " + p + "px; margin-top:-" + p / 2 + "px; margin-left:-" + p / 2 + "px; left:" + i + "px; top:" + o + 'px;"></div>'), e.prepend(n.$rippleWaveEl), n.rippleTransform = "translate3d(" + (s / 2 - i) + "px, " + (l / 2 - o) + "px, 0) scale(1)", Utils.nextFrame(function() {
    ...
    var Modal = function(n) {
            ...
            return n && (e.__proto__ = n), ((e.prototype = Object.create(n && n.prototype)).constructor = e).prototype.onOpen = function() {
                ...
                return n.params.modal.moveToRoot && !l.is(n.root) && (n.root.append(r), a.once(o + "Closed", function() {
                    ...
                    i && (i.removeClass("not-animated"), i.addClass("backdrop-in")), r.animationEnd(function() {
                        c()
                    }), r.transitionEnd(function() {
                        c()
                    }), r.removeClass("modal-out not-animated").addClass("modal-in"), a.onOpen()
                }) : (i && i.addClass("backdrop-in not-animated"), r.removeClass("modal-out").addClass("modal-in not-animated"), a.onOpen(), a.onOpened()), a
        ...
        CustomModal = function(s) {
            function e(e, t) {
                ...
                return i.params.backdrop && 0 === (r = e.root.children(".custom-modal-backdrop")).length && (r = $('<div class="custom-modal-backdrop"></div>'), e.root.append(r)), i.on("customModalOpened", function() {
        ...
        Dialog = function(y) {
            function e(a, e) {
                ...
                return 0 === m.length && (m = $('<div class="dialog-backdrop"></div>'), a.root.append(m)), l && 0 < l.length && (r.on("open", function() {
                    ...
                    n.find(".dialog-button").each(function(e, t) {
                        $(t).off("click", v)
                    }), !f || a.device.ios || a.device.android || a.device.cordova || $(doc).off("keydown", g), f = !1
                })), Utils.extend(r, {
                    app: a,
                    $el: n,
                    el: n[0],
                    ...
                    setText: function(e) {
                        ...
                        return 0 === t.length && (t = $('<div class="dialog-text"></div>'), void 0 !== i ? t.insertAfter(n.find(".dialog-title")) : n.find(".dialog-inner").prepend(t)), t.html(e), r.params.text = e, r
                    },
                    setTitle: function(e) {
                        var t = n.find(".dialog-title");
                        return 0 === t.length && (t = $('<div class="dialog-title"></div>'), n.find(".dialog-inner").prepend(t)), t.html(e), r.params.title = e, r
                    }
    ...
    var Dialog$1 = {
        ...
        Popup = function(s) {
            function e(e, t) {
                ...
                return i.params.backdrop && 0 === (r = e.root.children(".popup-backdrop")).length && (r = $('<div class="popup-backdrop"></div>'), e.root.append(r)), Utils.extend(i, {
                    app: e,
                    $el: n,
                    el: n[0],
                    $backdropEl: r,
        ...
        Actions = function(s) {
            function e(l, e) {
                ...
                function u(e) {
                    var t, a, n = this;
                    if ($(n).hasClass("item-link") ? (t = $(n).parents("li").index(), a = $(n).parents(".list").index()) : (t = $(n).index(), a = $(n).parents(".actions-group").index()), void 0 !== i) {
                        var r = i[a][t];
        ...
        Swipeout = {
            init: function() {
                ...
                P.on("touchstart", function(e) {
                    ...
                    Swipeout.allow && (l = !(p = !1), s = void 0, O.x = "touchstart" === e.type ? e.targetTouches[0].pageX : e.pageX, O.y = "touchstart" === e.type ? e.targetTouches[0].pageY : e.pageY, c = (new Date).getTime(), u = $(this))
                        ...
                        if (void 0 === s && (s = !!(s || Math.abs(a - O.y) > Math.abs(t - O.x))), s) l = !1;
                            ...
                            if (M = T = !1, 0 < f.length) {
                                ...
                                r = i / g, i < -g && (i = -g - Math.pow(-i - g, .8), b = i, 0 < S.length && (M = !0)), "to-left" !== E && (i = r = 0), x.each(function(e, t) {
                                    var a = $(t);
                                    void 0 === t.f7SwipeoutButtonOffset && (a[0].f7SwipeoutButtonOffset = t.offsetLeft), n = t.f7SwipeoutButtonOffset, 0 < S.length && a.hasClass("swipeout-overswipe") && "to-left" === E && (a.css({
                                        left: (M ? -n : 0) + "px"
                                    }), M ? a.addClass("swipeout-overswipe-active") : a.removeClass("swipeout-overswipe-active")), a.transform("translate3d(" + (i - n * (1 + Math.max(r, -1))) + "px,0,0)")
                                })
                            }
                            if (0 < m.length) {
                                var o = b;
                                r = o / v, v < o && (o = v + Math.pow(o - v, .8), b = o, 0 < k.length && (T = !0)), "to-right" !== E && (r = o = 0), C.each(function(e, t) {
                                    var a = $(t);
                                    void 0 === t.f7SwipeoutButtonOffset && (a[0].f7SwipeoutButtonOffset = v - t.offsetLeft - t.offsetWidth), n = t.f7SwipeoutButtonOffset, 0 < k.length && a.hasClass("swipeout-overswipe") && "to-right" === E && (a.css({
                                        left: (T ? n : 0) + "px"
                                    }), T ? a.addClass("swipeout-overswipe-active") : a.removeClass("swipeout-overswipe-active")), 1 < C.length && a.css("z-index", C.length - e), a.transform("translate3d(" + (o + n * (1 - Math.min(r, 1))) + "px,0,0)")
                                })
                            }
                    ...
                    if (l && p) {
                        ...
                        C && 0 < C.length && C !== t && C.each(function(e, t) {
                            ...
                            y && "open" === e || !y && "close" === e || (u.trigger("open" === e ? "swipeout:opened" : "swipeout:closed"), P.emit("open" === e ? "swipeoutOpened" : "swipeoutClosed", u[0]), u.removeClass("swipeout-transitioning"), y && "close" === e && (0 < f.length && x.transform(""), 0 < m.length && C.transform("")))
                        })
                    } else p = l = !1
                })
            },
        ...
        Accordion = {
            ...
            open: function(e) {
                ...
                if (r.removeAttr("aria-hidden"), 0 === r.length && (r = a.find(".accordion-item-content")), 0 !== r.length) {
                    ...
                    0 < i.length && t.accordion.close(i), r.transitionEnd(function() {
                        a.hasClass("accordion-item-opened") ? (r.transition(0), r.css("height", "auto"), Utils.nextFrame(function() {
                            r.transition("")
                        }), r.transition(""), a.trigger("accordion:opened"), t.emit("accordionOpened", a[0])) : (r.css("height", ""), a.trigger("accordion:closed"), t.emit("accordionClosed", a[0]))
            ...
            close: function(e) {
                ...
                0 === n.length && (n = a.find(".accordion-item-content")), a.removeClass("accordion-item-opened"), n.attr("aria-hidden", !0), n.transition(0), n.css("height", n[0].scrollHeight + "px"), n.transitionEnd(function() {
                    a.hasClass("accordion-item-opened") ? (n.transition(0), n.css("height", "auto"), Utils.nextFrame(function() {
                        n.transition("")
                    }), a.trigger("accordion:opened"), t.emit("accordionOpened", a[0])) : (n.css("height", ""), a.trigger("accordion:closed"), t.emit("accordionClosed", a[0]))
                }), Utils.nextFrame(function() {
        ...
        VirtualList = function(u) {
            function e(e, t) {
                ...
                if (a.useModulesParams(n), a.params = Utils.extend(n, t), void 0 !== a.params.height && a.params.height || (a.params.height = "md" === e.theme ? 48 : 44), a.$el = $(t.el), a.el = a.$el[0], 0 !== a.$el.length) {
                    ...
                    var r, i = a.params.ul;
                    a.$ul = i ? $(a.params.ul) : a.$el.children("ul"), 0 === a.$ul.length && a.params.createUl && (a.$el.append("<ul></ul>"), a.$ul = a.$el.children("ul")), a.ul = a.$ul[0], r = a.ul || a.params.createUl ? a.$ul : a.$el, Utils.extend(a, {
                        $itemsWrapEl: r,
                        itemsWrapEl: r[0],
                        domCache: {},
                        displayDomCache: {},
        ...
        Tab = {
            show: function() {
                ...
                if (y.removeClass("tab-active").trigger("tab:hide"), p.emit("tabHide", y[0]), d.addClass("tab-active").trigger("tab:show"), p.emit("tabShow", d[0]), !c && ((!(c = $("string" == typeof i ? '.tab-link[href="' + i + '"]' : '.tab-link[href="#' + d.attr("id") + '"]')) || c && 0 === c.length) && $("[data-tab]").each(function(e, t) {
                        d.is($(t).attr("data-tab")) && (c = $(t))
                    }), l && (!c || c && 0 === c.length) && 0 === (c = $('[data-route-tab-id="' + l.route.tab.id + '"]')).length && (c = $('.tab-link[href="' + l.url + '"]')), 1 < c.length && d.parents(".page").length && (c = c.filter(function(e, t) {
                ...
                if (0 < c.length) {
                    ...
                    if (x && 1 < x.length && y && y.parents(".page").length && (x = x.filter(function(e, t) {
                        ...
                        })), x && 0 < x.length && x.removeClass("tab-link-active"), c && 0 < c.length && (c.addClass("tab-link-active"), "md" === p.theme && p.toolbar)) {
    ...
    function swipePanel(i) {
        ...
        function e(e) {
            if (i.swipeable && r.panel.allowOpen && (v.swipe || v.swipeOnlyClose) && !o && !(0 < $(".modal-in, .photo-browser-in").length) && (t = r.panel["left" === y ? "right" : "left"] || {}, (i.opened || !t.opened) && (v.swipeCloseOpposite || v.swipeOnlyClose || !t.opened) && (!e.target || "input" !== e.target.nodeName.toLowerCase() || "range" !== e.target.type) && !(0 < $(e.target).closest(".range-slider, .tabs-swipeable-wrap, .calendar-months, .no-swipe-panel").length) && (C.x = "touchstart" === e.type ? e.targetTouches[0].pageX : e.pageX, C.y = "touchstart" === e.type ? e.targetTouches[0].pageY : e.pageY, (!v.swipeOnlyClose || i.opened) && ("both" === v.swipe || !v.swipeCloseOpposite || v.swipe === y || i.opened)))) {
                if (v.swipeActiveArea && !i.opened) {
                    if ("left" === y && C.x > v.swipeActiveArea) return;
                    if ("right" === y && C.x < r.width - v.swipeActiveArea) return
                }
                if (v.swipeCloseActiveAreaSide && i.opened) {
                    if ("left" === y && C.x < g[0].offsetWidth - v.swipeCloseActiveAreaSide) return;
                    if ("right" === y && C.x > r.width - g[0].offsetWidth + v.swipeCloseActiveAreaSide) return
                }
                x = 0, m = $(i.getViewEl()), o = !(s = !1), l = void 0, p = Utils.now(), f = void 0
            }
        }
        ...
        function a(e) {
            if (o && !((x += 1) < 2))
                if (e.f7PreventSwipePanel || r.preventSwipePanelBySwipeBack || r.preventSwipePanel) o = !1;
                    ...
                    var t = "touchmove" === e.type ? e.targetTouches[0].pageX : e.pageX,
                        a = "touchmove" === e.type ? e.targetTouches[0].pageY : e.pageY;
                    if (void 0 === l && (l = !!(l || Math.abs(a - C.y) > Math.abs(t - C.x))), l) o = !1;
                    else {
                        if (!f) {
                            if (f = t > C.x ? "to-right" : "to-left", "both" === v.swipe && 0 < v.swipeActiveArea && !i.opened) {
                                if ("left" === y && C.x > v.swipeActiveArea) return void(o = !1);
                                if ("right" === y && C.x < r.width - v.swipeActiveArea) return void(o = !1)
                            }
                        ...
                        "right" === y && (n = -n), c = t - C.x + n, "right" === y ? "cover" === w ? ((d = c + (i.opened ? 0 : h)) < 0 && (d = 0), h < d && (d = h)) : (0 < (d = c - (i.opened ? h : 0)) && (d = 0), d < -h && (d = -h)) : ((d = c + (i.opened ? h : 0)) < 0 && (d = 0), h < d && (d = h)), "reveal" === w ? (m.transform("translate3d(" + d + "px,0,0)").transition(0), b.transform("translate3d(" + d + "px,0,0)").transition(0)) : ("left" === y && (d -= h), g.transform("translate3d(" + d + "px,0,0)").transition(0), b.transition(0), u = 1 - Math.abs(d / h), b.css({
                            opacity: u
    ...
    var Panel = function(p) {
            function e(e, t) {
                ...
                return 0 === l.length && (l = $('<div class="panel-backdrop"></div>')).insertBefore(r), Utils.extend(this, {
                    app: e,
                    side: o,
                    effect: s,
                    $el: r,
            ...
            return p && (e.__proto__ = p), ((e.prototype = Object.create(p && p.prototype)).constructor = e).prototype.init = function() {
                ...
                if (!l.is(t.root)) {
                    ...
                    c.length ? o.insertBefore(c) : d.length ? o.insertAfter(c) : t.root.prepend(o), n.once("panelClosed", function() {
                        p ? l.append(o) : o.remove()
                    })
                }
                return !(a || o.hasClass("panel-visible-by-breakpoint") || o.hasClass("panel-active")) && (t.panel.close("left" === r ? "right" : "left", e), t.panel.allowOpen = !1, o[e ? "removeClass" : "addClass"]("not-animated"), o.css({
                    display: "block"
                }).addClass("panel-active"), s[e ? "removeClass" : "addClass"]("not-animated"), s.show(), Utils.nextFrame(function() {
                    $("html").addClass("with-panel with-panel-" + r + "-" + i), n.onOpen();
                    var a = "reveal" === i ? o.nextAll(".view, .views").eq(0) : o;
                    e ? function t() {
                        a.transitionEnd(function(e) {
                            $(e.target).is(a) ? (o.hasClass("panel-active") ? n.onOpened() : n.onClosed(), s.css({
                                display: ""
                            })) : t()
                        })
                    }() : (n.onOpened(), s.css({
                ...
                return t.onClose(), a.panel.allowOpen = !1, e ? (s.transitionEnd(function() {
                    ...
                    display: ""
                }), i.removeClass("not-animated"), $("html").removeClass("with-panel with-panel-transitioning with-panel-" + n + "-" + r), t.onClosed()), !0
        ...
        Panel$1 = {
            ...
            create: function() {
                ...
                Utils.extend(r.panel, {
                    ...
                    close: function(e, t) {
                        var a, n;
                        return n ? a = $(".panel-" + (n = e)) : n = (a = $(".panel.panel-active")).hasClass("panel-left") ? "left" : "right", !!n && (r.panel[n] ? r.panel[n].close(t) : 0 < a.length && r.panel.create({
                            el: a
                        }).close(t))
                    },
                    get: function(e) {
        ...
        if (0 !== o.length) {
            ...
            return o.find("input, select, textarea").each(function(e, t) {
                ...
                if (!a.hasClass("ignore-store-data") && !a.hasClass("no-store-data")) {
                    ...
                    //console.log("value: " + $$('#' + a.attr('id')).innerHTML())
        ...
        $(doc).on("submit change", "form.form-ajax-submit, form.form-ajax-submit-onchange", function(e, t) {
            ...
            if (("change" !== e.type || n.hasClass("form-ajax-submit-onchange")) && ("submit" === e.type && e.preventDefault(), "change" !== e.type || "fromdata" !== t)) {
                var r, a = (n.attr("method") || "GET").toUpperCase(),
                    ...
                    o = n.attr("action");
                o && (r = "POST" === a ? "application/x-www-form-urlencoded" === i ? s.form.convertToData(n[0]) : new win.FormData(n[0]) : Utils.serializeObject(s.form.convertToData(n[0])), s.request({
                    method: a,
                    url: o,
                    contentType: i,
                    data: r,
    ...
    var Form = {
        ...
        Range = function(A) {
            function e(t, a) {
                ...
                }), o.params.value || (void 0 !== s.value && (o.params.value = s.value), void 0 !== s.valueLeft && void 0 !== s.valueRight && (o.params.value = [parseFloat(s.valueLeft), parseFloat(s.valueRight)])), o.params.dual || (o.params.inputEl ? i = $(o.params.inputEl) : r.find('input[type="range"]').length && (i = r.find('input[type="range"]').eq(0)));
                var l = o.params,
                    p = l.dual,
                    c = l.step,
                    d = l.label,
                ...
                function P(e) {
                    if (!g && (o.params.draggableBar || 0 !== $(e.target).closest(".range-knob").length)) {
                        ...
                        o.dual ? Math.abs(o.value[0] - a) < Math.abs(o.value[1] - a) ? (k = 0, E = o.knobs[0], a = [a, o.value[1]]) : (k = 1, E = o.knobs[1], a = [o.value[0], a]) : (E = o.knobs[0], a = t * (o.max - o.min) + o.min), Utils.nextTick(function() {
                            g && E.addClass("range-knob-active-state")
                        }, 70), o.on("change", M), o.setValue(a, !0)
                    }
                }
        ...
        Stepper = function(z) {
            function e(e, t) {
                ...
                function M(e) {
                    b || (T || ($(e.target).closest(c).length ? k = "increment" : $(e.target).closest(d).length && (k = "decrement"), k && (E.x = "touchstart" === e.type ? e.targetTouches[0].pageX : e.pageX, E.y = "touchstart" === e.type ? e.targetTouches[0].pageY : e.pageY, b = !0, y = void 0, function e(t, a, n, r, i, o) {
                ...
                return a.attachEvents = function() {
                    d.on("click", D), c.on("click", I), a.params.watchInput && i && i.length && (i.on("input", R), i.on("click", A), i.on("blur", L), i.on("keyup", B)), a.params.autorepeat && (e.on("touchstart:passive", M), e.on("touchmove:active", P), e.on("touchend:passive", O))
                }, a.detachEvents = function() {
                    d.off("click", D), c.off("click", I), a.params.watchInput && i && i.length && (i.off("input", R), i.off("click", A), i.off("blur", L), i.off("keyup", B))
        ...
        Calendar = function(p) {
            function e(S, t) {
                ...
                if (T.params = Utils.extend({}, S.params.calendar, t), "jalali" === T.params.calendarType && Object.keys(T.params.jalali).forEach(function(e) {
                    ...
                    }), "jalali" === T.params.calendarType ? T.DateHandleClass = IDate : T.DateHandleClass = Date, T.params.containerEl && 0 === (e = $(T.params.containerEl)).length) return T;
                ...
                return r && (i = S.rtl ? -1 : 1), Utils.extend(T, {
                    ...
                    function b() {
                        a && n ? (n = a = !1, (new T.DateHandleClass).getTime() - t < 300 ? Math.abs(u) < 10 ? T.resetMonth() : 10 <= u ? S.rtl ? T.nextMonth() : T.prevMonth() : S.rtl ? T.prevMonth() : T.nextMonth() : d <= -.5 ? S.rtl ? T.prevMonth() : T.nextMonth() : .5 <= d ? S.rtl ? T.nextMonth() : T.prevMonth() : T.resetMonth(), setTimeout(function() {
                            f = !0
                        }, 100)) : n = a = !1
                    }
                    ...
                    e.find(".calendar-prev-month-button").on("click", C), e.find(".calendar-next-month-button").on("click", w), e.find(".calendar-prev-year-button").on("click", E), e.find(".calendar-next-year-button").on("click", x), m.on("click", y), T.params.touchMove && (m.on(S.touchEvents.start, v, k), S.on("touchmove:active", g), S.on("touchend:passive", b)), T.detachCalendarEvents = function() {
                        e.find(".calendar-prev-month-button").off("click", C), e.find(".calendar-next-month-button").off("click", w), e.find(".calendar-prev-year-button").off("click", E), e.find(".calendar-next-year-button").off("click", x), m.off("click", y), T.params.touchMove && (m.off(S.touchEvents.start, v, k), S.off("touchmove:active", g), S.off("touchend:passive", b))
                    }
                }, T.init(), T
            }
                ...
                if (!n) {
                    ...
                    var l = t.render(),
                        p = {
                            ...
                            on: {
                                open: function() {
                                    t.modal = this, t.$el = "popover" === s ? this.$el.find(".calendar") : this.$el, t.$wrapperEl = t.$el.find(".calendar-months-wrapper"), t.$months = t.$wrapperEl.find(".calendar-month"), t.$el[0].f7Calendar = t, "customModal" === s && $(t.$el).find(".calendar-close").once("click", function() {
                                        t.close()
                                    }), t.onOpen()
                                },
                                opened: function() {
    ...
    function pickerColumn(e, t) {
        ...
        if (!l.divider) {
            ...
            var u, h, f, m, v, g, b, y, w, C, x = !0,
                E = !!a.support.passiveListener && {
                    passive: !1,
                    capture: !1
                };
            l.attachEvents = function() {
                l.$el.on(a.touchEvents.start, S, E), a.on("touchmove:active", T), a.on("touchend:passive", M), l.items.on("click", P)
            }, l.detachEvents = function() {
                l.$el.off(a.touchEvents.start, S, E), a.off("touchmove:active", T), a.off("touchend:passive", M), l.items.off("click", P)
            }, l.init = function() {
        ...
        function S(e) {
            h || u || (e.preventDefault(), u = !0, f = "touchstart" === e.type ? e.targetTouches[0].pageY : e.pageY, m = f, v = (new Date).getTime(), x = !0, g = Utils.getTranslate(l.$itemsEl[0], "y"), y = g)
        }

        function T(e) {
            u && (e.preventDefault(), x = !1, m = "touchmove" === e.type ? e.targetTouches[0].pageY : e.pageY, h || (Utils.cancelAnimationFrame(d), h = !0, g = Utils.getTranslate(l.$itemsEl[0], "y"), y = g, l.$itemsEl.transition(0)), b = void 0, (y = g + (m - f)) < o && (y = o - Math.pow(o - y, .8), b = "min"), c < y && (y = c + Math.pow(y - c, .8), b = "max"), l.$itemsEl.transform("translate3d(0," + y + "px,0)"), l.updateItems(void 0, y, 0, s.params.updateValuesOnTouchmove), C = y - w || y, w = y)
        }
        ...
        function M() {
            if (u && h) {
                ...
                s.params.freeMode || (e = -t * p + c), l.$itemsEl.transform("translate3d(0," + parseInt(e, 10) + "px,0)"), l.updateItems(t, e, "", !0), s.params.updateValuesOnMomentum && (k(), l.$itemsEl.transitionEnd(function() {
                    Utils.cancelAnimationFrame(d)
                })), setTimeout(function() {
                    x = !0
                }, 100)
    ...
    var Picker = function(c) {
            function e(e, t) {
                ...
                return i.params.inputEl && (n = $(i.params.inputEl)), n && (r = n.parents(".view").length && n.parents(".view")[0].f7View), r || (r = e.views.main), Utils.extend(i, {
                    app: e,
                    $containerEl: a,
                    containerEl: a && a[0],
                    inline: a && 0 < a.length,
            ...
            return c && (e.__proto__ = c), ((e.prototype = Object.create(c && c.prototype)).constructor = e).prototype.initInput = function() {
                ...
                if (!n) {
                    if (0 === t.cols.length && t.params.cols.length && t.params.cols.forEach(function(e) {
                            t.cols.push(e)
                        }), r) return t.$el = $(t.render()), (t.$el[0].f7Picker = t).$containerEl.append(t.$el), t.onOpen(), void t.onOpened();
                    var o = t.isPopover(),
                        s = o ? "popover" : "sheet",
                        l = {
                            targetEl: i,
        ...
        PullToRefresh = function(T) {
            function e(t, e) {
                ...
                function r(e) {
                    ...
                    o.hasClass("ptr-refreshing") || $(e.target).closest(".sortable-handler").length || (p = !(y = c = !1), v = u = void 0, "touchstart" === e.type && (l = e.targetTouches[0].identifier), w.x = "touchstart" === e.type ? e.targetTouches[0].pageX : e.pageX, w.y = "touchstart" === e.type ? e.targetTouches[0].pageY : e.pageY)
                }
                        ...
                        if (t && a)
                            if (void 0 === u && (u = !!(u || Math.abs(a - w.y) > Math.abs(t - w.x))), u) {
                                if (m = o[0].scrollTop, void 0 === v && 0 !== m && (v = !0), !c) {
                                    ...
                                    b && 0 <= (g = o.attr("data-ptr-distance")).indexOf("%") && (g = o[0].offsetHeight * parseInt(g, 10) / 100), E = o.hasClass("ptr-refreshing") ? g : 0, x = !(o[0].scrollHeight !== o[0].offsetHeight && "ios" === Device.os && !d)
                                }
                                c = !0, 0 < (h = a - w.y) && m <= 0 || m < 0 ? ("ios" === Device.os && 7 < parseInt(Device.osVersion.split(".")[0], 10) && 0 === m && !v && (x = !0), x && (e.preventDefault(), f = Math.pow(h, .85) + E, d ? s.transform("translate3d(0," + f + "px,0)").find(".ptr-arrow").transform("rotate(" + (h / 66 * 180 + 100) + "deg)") : o.transform("translate3d(0," + f + "px,0)")), x && Math.pow(h, .85) > g || !x && 2 * g <= h ? (C = !0, o.addClass("ptr-pull-up").removeClass("ptr-pull-down")) : (C = !1, o.removeClass("ptr-pull-up").addClass("ptr-pull-down")), y || (o.trigger("ptr:pullstart"), i.emit("local::pullStart ptrPullStart", o[0]), y = !0), o.trigger("ptr:pullmove", {
                                    event: e,
                                    scrollTop: m,
                                    translate: f,
                                    touchesDiff: h
                                    ...
                                    translate: f,
                                    touchesDiff: h
                                })) : (y = !1, o.removeClass("ptr-pull-up ptr-pull-down"), C = !1)
                            } else p = !1
                    }
                }
                ...
                function S(e) {
                    ...
                    p && c ? (f && (o.addClass("ptr-transitioning"), f = 0), d ? s.transform("").find(".ptr-arrow").transform("") : o.transform(""), C ? (o.addClass("ptr-refreshing"), o.trigger("ptr:refresh", i.done), i.emit("local::refresh ptrRefresh", o[0], i.done)) : o.removeClass("ptr-pull-down"), c = p = !1, y && (o.trigger("ptr:pullend"), i.emit("local::pullEnd ptrPullEnd", o[0]))) : c = p = !1
                }
                return (0 < n.find(".navbar").length || 0 < n.parents(".view").children(".navbar").length) && (a = !0), n.hasClass("no-navbar") && (a = !1), a || o.addClass("ptr-no-navbar"), o.attr("data-ptr-distance") ? b = !0 : g = d ? 66 : 44, n.length && o.length && ((o[0].f7PullToRefresh = i).attachEvents = function() {
                    ...
                    o.on(t.touchEvents.start, r, e), t.on("touchmove", k), t.on("touchend:passive", S)
                }, i.detachEvents = function() {
                    var e = !!Support.passiveListener && {
                        passive: !0
                    };
                    o.off(t.touchEvents.start, r, e), t.off("touchmove", k), t.off("touchend:passive", S)
        ...
        Searchbar = function(k) {
            function e(e, t) {
                ...
                return t.foundEl ? o = $(t.foundEl) : "string" == typeof a.params.foundEl && r && (o = r.find(a.params.foundEl)), t.notFoundEl ? s = $(t.notFoundEl) : "string" == typeof a.params.notFoundEl && r && (s = r.find(a.params.notFoundEl)), t.hideOnEnableEl ? l = $(t.hideOnEnableEl) : "string" == typeof a.params.hideOnEnableEl && r && (l = r.find(a.params.hideOnEnableEl)), t.hideOnSearchEl ? p = $(t.hideOnSearchEl) : "string" == typeof a.params.hideOnSearchEl && r && (p = r.find(a.params.hideOnSearchEl)), a.params.backdrop && 0 === (c = a.params.backdropEl ? $(a.params.backdropEl) : r && 0 < r.length ? r.find(".searchbar-backdrop") : f.siblings(".searchbar-backdrop")).length && (c = $('<div class="searchbar-backdrop"></div>'), r && r.length ? 0 < f.parents(r).length && i && 0 === f.parents(i).length ? c.insertBefore(f) : c.insertBefore(r.find(".page-content").eq(0)) : c.insertBefore(f)), a.params.searchContainer && (d = $(a.params.searchContainer)), u = a.params.inputEl ? $(a.params.inputEl) : f.find('input[type="search"]').eq(0), a.params.disableButton && (h = a.params.disableButtonEl ? $(a.params.disableButtonEl) : f.find(".searchbar-disable-button")), Utils.extend(a, {
                    ...
                    f.on("submit", v), a.params.disableButton && a.$disableButtonEl.on("click", C), a.params.disableOnBackdropClick && a.$backdropEl && a.$backdropEl.on("click", C), a.expandable && "ios" === e.theme && a.view && i && a.$pageEl && (a.$pageEl.on("page:beforeout", x), a.$pageEl.on("page:beforein", E)), a.$inputEl.on("focus", g), a.$inputEl.on("blur", b), a.$inputEl.on("change input compositionend", y), a.$inputEl.on("input:clear", w)
                }, a.detachEvents = function() {
                    f.off("submit", v), a.params.disableButton && a.$disableButtonEl.off("click", C), a.params.disableOnBackdropClick && a.$backdropEl && a.$backdropEl.off("click", C), a.expandable && "ios" === e.theme && a.view && i && a.$pageEl && (a.$pageEl.off("page:beforeout", x), a.$pageEl.off("page:beforein", E)), a.$inputEl.off("focus", g), a.$inputEl.off("blur", b), a.$inputEl.off("change input compositionend", y), a.$inputEl.off("input:clear", w)
                }, a.useModules(), a.init(), a
            }
            return k && (e.__proto__ = k), ((e.prototype = Object.create(k && k.prototype)).constructor = e).prototype.clear = function(e) {
                if (!this.query && e && $(e.target).hasClass("searchbar-clear")) return this.disable(), this;
                var t = this.value;
                ...
                if (!e.expandable) {
                    var t = e.app;
                    e.$disableButtonEl.transition(0).show(), e.$disableButtonEl.css("margin-" + (t.rtl ? "left" : "right"), -e.disableButtonEl.offsetWidth + "px"), Utils.nextFrame(function() {
                        e.$disableButtonEl.transition(""), e.disableButtonHasMargin = !0
                    })
                }
        ...
        Messages = function(i) {
            ...
            return i && (e.__proto__ = i), ((e.prototype = Object.create(i && i.prototype)).constructor = e).prototype.getMessageData = function(e) {
                ...
                void 0 === t && (t = !0);
                var a, n, r = this;
                return "number" == typeof e ? (a = e, n = r.$el.find(".message, .messages-title").eq(a)) : r.messages && 0 <= r.messages.indexOf(e) ? (a = r.messages.indexOf(e), n = r.$el.children().eq(a)) : a = (n = $(e)).index(), 0 === n.length || (n.remove(), r.messages.splice(a, 1), r.params.autoLayout && t && r.layout()), r
    ...
    function updateSlides() {
        ...
        if (void 0 !== n) {
            ...
            "string" == typeof g && 0 <= g.indexOf("%") && (g = parseFloat(g.replace("%", "")) / 100 * n), e.virtualSize = -g, r ? l.css({
                ...
                marginRight: "",
                marginBottom: ""
            }), 1 < t.slidesPerColumn && (C = Math.floor(p / t.slidesPerColumn) === p / e.params.slidesPerColumn ? p : Math.ceil(p / t.slidesPerColumn) * t.slidesPerColumn, "auto" !== t.slidesPerView && "row" === t.slidesPerColumnFill && (C = Math.max(C, t.slidesPerView * t.slidesPerColumn)));
            for (var $, E = t.slidesPerColumn, k = C / E, S = k - (t.slidesPerColumn * k - p), T = 0; T < p; T += 1) {
                ...
                if (1 < t.slidesPerColumn) {
                    var P = void 0,
                        O = void 0,
                        D = void 0;
                    "column" === t.slidesPerColumnFill ? (D = T - (O = Math.floor(T / E)) * E, (S < O || O === S && D === E - 1) && E <= (D += 1) && (D = 0, O += 1), P = O + D * C / E, M.css({
                ...
                if ("none" !== M.css("display")) {
                    if ("auto" === t.slidesPerView) {
                        ...
                        A && (M[0].style.transform = "none"), B && (M[0].style.webkitTransform = "none"), x = t.roundLengths ? e.isHorizontal() ? M.outerWidth(!0) : M.outerHeight(!0) : e.isHorizontal() ? M[0].getBoundingClientRect().width + parseFloat(I.getPropertyValue("margin-left")) + parseFloat(I.getPropertyValue("margin-right")) : M[0].getBoundingClientRect().height + parseFloat(I.getPropertyValue("margin-top")) + parseFloat(I.getPropertyValue("margin-bottom")), A && (M[0].style.transform = A), B && (M[0].style.webkitTransform = B), t.roundLengths && (x = Math.floor(x))
            ...
            if (e.virtualSize = Math.max(e.virtualSize, n) + f, r && i && ("slide" === t.effect || "coverflow" === t.effect) && a.css({
                ...
                })), 1 < t.slidesPerColumn && (e.virtualSize = (x + t.spaceBetween) * C, e.virtualSize = Math.ceil(e.virtualSize / t.slidesPerColumn) - t.spaceBetween, e.isHorizontal() ? a.css({
                    width: e.virtualSize + t.spaceBetween + "px"
                }) : a.css({
                    height: e.virtualSize + t.spaceBetween + "px"
                }), t.centeredSlides)) {
    ...
    function slideToClickedSlide() {
        ...
        if (a.loop) {
            ...
            e = parseInt($(t.clickedSlide).attr("data-swiper-slide-index"), 10), a.centeredSlides ? i < t.loopedSlides - r / 2 || i > t.slides.length - t.loopedSlides + r / 2 ? (t.loopFix(), i = n.children("." + a.slideClass + '[data-swiper-slide-index="' + e + '"]:not(.' + a.slideDuplicateClass + ")").eq(0).index(), Utils.nextTick(function() {
                t.slideTo(i)
            ...
            if (i.originalEvent && (i = i.originalEvent), a.isTouchEvent = "touchstart" === i.type, (a.isTouchEvent || !("which" in i) || 3 !== i.which) && !(!a.isTouchEvent && "button" in i && 0 < i.button || a.isTouched && a.isMoved))
                ...
                if (!l || !(o <= p || o >= win.screen.width - p)) {
                    if (Utils.extend(a, {
                        ...
                        var c = !0;
                        $(i.target).is(a.formElements) && (c = !1), doc.activeElement && $(doc.activeElement).is(a.formElements) && doc.activeElement !== i.target && doc.activeElement.blur(), c && t.allowTouchMove && n.touchStartPreventDefault && i.preventDefault()
                    }
                    t.emit("touchStart", i)
                }
            }
    ...
    function onTouchEnd(e) {
        ...
        if (a.isTouched = !1, a.isMoved = !1, a.startMoving = !1, c = n.followFinger ? i ? t.translate : -t.translate : -a.currentTranslate, n.freeMode) {
            ...
            if (n.freeModeMomentum) {
                ...
                n.freeModeMomentumBounce && x ? (t.updateProgress(w), t.setTransition(g), t.setTranslate(y), t.transitionStart(!0, t.swipeDirection), t.animating = !0, o.transitionEnd(function() {
    ...
    var breakpoints = {
        ...
        Browser = {
            ...
            isSafari: (_1a = win.navigator.userAgent.toLowerCase(), 0 <= _1a.indexOf("safari") && _1a.indexOf("chrome") < 0 && _1a.indexOf("android") < 0),
    ...
    var checkOverflow$1 = {
        ...
        Virtual = {
            update: function(e) {
                ...
                v = t.rtlTranslate ? "right" : t.isHorizontal() ? "left" : "top", i ? (g = Math.floor(n / 2) + r + s, b = Math.floor(n / 2) + r + l) : (g = n + (r - 1) + s, b = r + l);
                ...
                if (Utils.extend(t.virtual, {
                    ...
                    }), c === w && d === C && !e) return t.slidesGrid !== h && x !== m && t.slides.css(v, x + "px"), void t.updateProgress();
        ...
        Scrollbar = {
            ...
            init: function() {
                if (this.params.scrollbar.el) {
                    ...
                    0 === r.length && (r = $('<div class="' + this.params.scrollbar.dragClass + '"></div>'), n.append(r)), Utils.extend(e, {
                        $el: n,
                        el: n[0],
                        $dragEl: r,
                        dragEl: r[0]
        ...
        Parallax = {
            ...
            setTranslate: function() {
                ...
                e.children("[data-swiper-parallax], [data-swiper-parallax-x], [data-swiper-parallax-y]").each(function(e, t) {
                    ...
                    var a = t.progress;
                    1 < n.params.slidesPerGroup && "auto" !== n.params.slidesPerView && (a += Math.ceil(e / 2) - r * (i.length - 1)), a = Math.min(Math.max(a, -1), 1), $(t).find("[data-swiper-parallax], [data-swiper-parallax-x], [data-swiper-parallax-y]").each(function(e, t) {
        ...
        Cube = {
            setTranslate: function() {
                var e, t = this,
                    ...
                    u = 0;
                p.shadow && (c ? (0 === (e = n.find(".swiper-cube-shadow")).length && (e = $('<div class="swiper-cube-shadow"></div>'), n.append(e)), e.css({
                    height: i + "px"
        ...
        Thumbs = {
            ...
            onThumbClick: function() {
                ...
                if (t) {
                    ...
                    if (null != a) {
                        var n;
                        if (n = t.params.loop ? parseInt($(t.clickedSlide).attr("data-swiper-slide-index"), 10) : a, e.params.loop) {
                            var r = e.activeIndex;
        ...
        Notification = function(M) {
            function e(n, e) {
                ...
                Utils.extend(r, {
                    ...
                    g && $(e.target).closest(".notification-close-button").length || (r.emit("local::click notificationClick", r), w && r.close())
                }), r.on("beforeDestroy", function() {
                    a.off("click")
                });
                var x, E = {};
                ...
                function k(e) {
                    i || (o = !(i = !0), s = void 0, p = Utils.now(), E.x = "touchstart" === e.type ? e.targetTouches[0].pageX : e.pageX, E.y = "touchstart" === e.type ? e.targetTouches[0].pageY : e.pageY)
                }
        ...
        Autocomplete = function(w) {
            function e(e, t) {
                ...
                return d.attachEvents = function() {
                    "dropdown" !== d.params.openIn && d.$openerEl && d.$openerEl.on("click", f), "dropdown" === d.params.openIn && d.$inputEl && (d.$inputEl.on("focus", m), d.$inputEl.on(d.params.inputEvents, l), e.device.android ? $("html").on("click", c) : d.$inputEl.on("blur", v), d.params.typeahead && d.$inputEl.on("keydown", b))
                }, d.detachEvents = function() {
                    "dropdown" !== d.params.openIn && d.$openerEl && d.$openerEl.off("click", f), "dropdown" === d.params.openIn && d.$inputEl && (d.$inputEl.off("focus", m), d.$inputEl.off(d.params.inputEvents, l), e.device.android ? $("html").off("click", c) : d.$inputEl.off("blur", v), d.params.typeahead && d.$inputEl.off("keydown", b))
            ...
            return w && (e.__proto__ = w), ((e.prototype = Object.create(w && w.prototype)).constructor = e).prototype.positionDropdown = function() {
                ...
                if (a.$el = r, a.el = r[0], a.openedIn = e, a.opened = !0, "dropdown" === a.params.openIn) a.attachDropdownEvents(), a.$dropdownEl.addClass("autocomplete-dropdown-in"), a.$inputEl.trigger("input");
                    ...
                    var i = r.find(".searchbar");
                    "page" === a.params.openIn && "ios" === n.theme && 0 === i.length && (i = $(n.navbar.getElByPage(r)).find(".searchbar")), a.searchbar = n.searchbar.create({
                        el: i,
                        backdropEl: r.find(".searchbar-backdrop"),
                        customSearch: !0,
                        on: {
